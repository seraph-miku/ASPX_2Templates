<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ASPX_2Templates.Default" %>
...
<head runat="server">
    ...
    <title>InCorpo Corporate Category Bootstrap Responsive Template | Home :: W3layouts</title>
    <link
...
<body>
    ...
    <a href="#" data-toggle="modal" data-target="#exampleModalCenter2">Register</a>
                            ...
                            <div class="banner-info">
                                <div class="container">
                                    <div class="banner-info-bg">
                                        ...
                                        <h5>Work With Reliable Partners</h5>
        ...
        <div class="container py-md-5 py-3">
            <div class="row bottom-ab-grids align-items-center">
                ...
                <div class="col-lg-6 bottom-ab-left">
                    ...
                    <h3 class="hny-title">We grow brands, create experiences and solve business problems.</h3>
                    <p class="my-3">
            ...
            <div class="row features-w3pvt-main" id="features">
                <div class="col-lg-4 col-md-6 feature-gird">
                    <div class="row features-hny-inner-gd">
                        ...
                        <div class="col-md-10 col-10 featured_grid_right_info">
                            <h4><a class="link-hny" href="#url">Product
                  Development</a></h4>
                            <p>
                                Lorem ipsum dolor sit amet elit consec tetur adipisi elit.,Vestibulum ante ipsum primis in faucibus
                orci luctus et ultrices posuere cubilia Curae rem!
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 feature-gird mt-lg-0 mt-md-5 mt-4">
                    <div class="row features-hny-inner-gd">
                        ...
                        <div class="col-md-10 col-10 featured_grid_right_info">
                            <h4><a class="link-hny" href="#url">Big Data
                  & Analytics</a></h4>
                            <p>
                                Lorem ipsum dolor sit amet elit consec tetur adipisi elit.,Vestibulum ante ipsum primis in faucibus
                orci luctus et ultrices posuere cubilia Curae rem!
    ...
    <div class="w3l-middle py-5">
        <div class="container py-xl-5 py-lg-3">
            <div class="welcome-left py-md-5 py-3">
                ...
                <p class="pr-lg-5">
                    Lorem ipsum dolor sit amet, consectetur adipisicingelit, sed do eiusmod tempor incididunt ut
        ...
        <div class="container py-md-5 py-3">
            <div class="cwp4-two row align-items-center">
                ...
                <div class="cwp4-text col-lg-6 mt-lg-0 mt-5">
                    ...
                    <h3 class="hny-title">We Take Care of Your Technology</h3>
                    <p>
            ...
            dolore magna aliqua.
                    ...
                    <ul class="cont-4 mt-lg-6 mt-md-5 mt-4">
                        <li class="subhny-gd mt-sm-0 mt-4">
                            ...
                            <h4><a class="link-hny" href="#url">Business Planning</a></h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicingelit</p>
                        </li>
                        <li class="subhny-gd mt-sm-0 mt-4">
                            <span class="fa fa-bar-chart"></span>
                            <h4><a class="link-hny" href="#url">Business Analysis</a></h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicingelit</p>
                        </li>
                    </ul>
                </div>
        ...
        <section id="grids5-block" class="py-5">
            <div class="container py-lg-4">
                <div class="header-section text-center mx-auto">
                    <h6 class="sub-titlehny">Blog Posts</h6>
                    <h3 class="hny-title">Recent blog entries</h3>
                </div>
                <div class="grid-view">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mt-5">
                            <div class="grids5-info">
                                <a href="#" class="d-block zoom">
                                    <img src="assets/images/2.jpg" alt="" class="img-fluid news-image" />
                                </a>
                                <div class="blog-info">
                                    <p class="date">06 May, 2020</p>
                                    <a href="#">
                                        <h4>How to Live a Balanced Life like Everyone</h4>
                                    </a>
                                    <p class="blog-text">
                    ...
                    molestiae ullam
                        ...
                        <div class="col-lg-4 col-md-6 mt-5">
                            <div class="grids5-info">
                                <a href="#" class="d-block zoom">
                                    <img src="assets/images/5.jpg" alt="" class="img-fluid news-image" />
                                </a>
                                <div class="blog-info">
                    ...
                    molestiae ullam
                        ...
                        <div class="col-lg-4 offset-md-3 offset-lg-0 col-md-6 mt-5">
                            <div class="grids5-info">
                                <a href="#" class="d-block zoom">
                                    <img src="assets/images/4.jpg" alt="" class="img-fluid news-image" />
                                </a>
                                <div class="blog-info">
        ...
        <div class="news-mainhny py-5">
            <div class="container text-center py-lg-3">
                <div class="title-content text-center mb-lg-5 mb-4">
                    ...
                    <h3 class="hny-title">Our Projects</h3>
                </div>
            </div>
            <div class="owl-news owl-carousel owl-theme">
                <div class="item">
                    <div class="news-img position-relative">
                        <a href="#">
                            <img src="assets/images/1.jpg" class="img-fluid" alt="news image"></a>
                        <div class="title-wrap">
                            <a href="#">
                                <h4 class="title">New Brands</h4>
                            </a>
                ...
                <div class="item">
                    <div class="news-img">
                        <a href="#">
                            <img src="assets/images/2.jpg" class="img-fluid" alt="news image"></a>
                        <div class="title-wrap">
                            <a href="#">
                                <h4 class="title">Creative Mind</h4>
                            </a>
                            <a href="#" class="text-right"><span class="fa fa-arrow-right"></span></a>
                        </div>
                    </div>
                ...
                <div class="item">
                    <div class="news-img">
                        <a href="#">
                            <img src="assets/images/3.jpg" class="img-fluid" alt="news image"></a>
                        <div class="title-wrap">
                            <a href="#">
                ...
                <div class="item">
                    <div class="news-img">
                        <a href="#">
                            <img src="assets/images/4.jpg" class="img-fluid" alt="news image"></a>
                        <div class="title-wrap">
                            <a href="#">
                ...
                <div class="item">
                    <div class="news-img">
                        <a href="#">
                            <img src="assets/images/5.jpg" class="img-fluid" alt="news image"></a>
                        <div class="title-wrap">
                            <a href="#">
                ...
                <div class="item">
                    <div class="news-img">
                        <a href="#">
                            <img src="assets/images/6.jpg" class="img-fluid" alt="news image"></a>
                        <div class="title-wrap">
                            <a href="#">
                                <h4 class="title">Tech Conference</h4>
                            </a>
                            <a href="#" class="text-right"><span class="fa fa-arrow-right"></span></a>
                        </div>
                    </div>
                ...
                <div class="container pt-lg-4">
                                ...
                                <li>
                                    <p>
                                        <span class="fa fa-phone" aria-hidden="true"></span><a
                                            href="tel:+44-255-366-88">+44-255-366-88</a>
                                    </p>
                                </li>
                                <li>
                        ...
                        <div class="col-lg-5 col-md-5 column pl-md-5 mt-md-0 mt-5">
                            ...
                            <a class="d-grid twitter-feed" href="services.html">
                                ...
                                <p class="twitter-title">
                                    Learn by doing with Real World Projects Lorem, ipsum.<br>
                            ...
                            <a class="d-grid twitter-feed" href="services.html">
                                ...
                                <p class="twitter-title">
                                    Using Creative Problem Solving Lorem ipsum dolor sit.<br>
                    ...
                    <div class="below-section pt-4 mt-4 text-center">
                        ...
                        <div class="columns mt-3">
                            <p>
                                &copy; 2020 InCorpo. All rights reserved | Design by <a href="https://w3layouts.com/">W3Layouts</a>
                            </p>
                        </div>
                    </div>
                </div>
